...
RSpec.describe do
  ...
  it "Sort roman numeral characters" do
    expect(RomanNumeralUtil.sort_roman_characters("IIVXXLCCDMM")).to eq "MMDCCLXXVII"
    expect(RomanNumeralUtil.sort_roman_characters("MDCLXVI"+"MDCLXVI")).to eq "MMDDCCLLXXVVII"
  end
  ...
  it "Shrink rule (I)" do
    expect(RomanNumeralUtil.shrink5_I("I")).to eq "I"
    expect(RomanNumeralUtil.shrink5_I("II")).to eq "II"
    expect(RomanNumeralUtil.shrink5_I("III")).to eq "III"
    expect(RomanNumeralUtil.shrink5_I("IIII")).to eq "IV"
    expect(RomanNumeralUtil.shrink5_I("IIIII")).to eq "V"
    expect(RomanNumeralUtil.shrink5_I("IIIIII")).to eq "VI"
    expect(RomanNumeralUtil.shrink5_I("IIIIIII")).to eq "VII"
    expect(RomanNumeralUtil.shrink5_I("IIIIIIII")).to eq "VIII"
    expect(RomanNumeralUtil.shrink5_I("IIIIIIIII")).to eq "VIV"
    expect(RomanNumeralUtil.shrink5_I("IIIIIIIIII")).to eq "VV"
  end

  it "Shrink rule (X)" do
    expect(RomanNumeralUtil.shrink5_X("X")).to eq "X"
    expect(RomanNumeralUtil.shrink5_X("XX")).to eq "XX"
    expect(RomanNumeralUtil.shrink5_X("XXX")).to eq "XXX"
    expect(RomanNumeralUtil.shrink5_X("XXXX")).to eq "XL"
    expect(RomanNumeralUtil.shrink5_X("XXXXX")).to eq "L"
    expect(RomanNumeralUtil.shrink5_X("XXXXXX")).to eq "LX"
    expect(RomanNumeralUtil.shrink5_X("XXXXXXX")).to eq "LXX"
    expect(RomanNumeralUtil.shrink5_X("XXXXXXXX")).to eq "LXXX"
    expect(RomanNumeralUtil.shrink5_X("XXXXXXXXX")).to eq "LXL"
    expect(RomanNumeralUtil.shrink5_X("XXXXXXXXXX")).to eq "LL"
  end

  it "Shrink rule (C)" do
    expect(RomanNumeralUtil.shrink5_C("C")).to eq "C"
    expect(RomanNumeralUtil.shrink5_C("CC")).to eq "CC"
    expect(RomanNumeralUtil.shrink5_C("CCC")).to eq "CCC"
    expect(RomanNumeralUtil.shrink5_C("CCCC")).to eq "CD"
    expect(RomanNumeralUtil.shrink5_C("CCCCC")).to eq "D"
    expect(RomanNumeralUtil.shrink5_C("CCCCCC")).to eq "DC"
    expect(RomanNumeralUtil.shrink5_C("CCCCCCC")).to eq "DCC"
    expect(RomanNumeralUtil.shrink5_C("CCCCCCCC")).to eq "DCCC"
    expect(RomanNumeralUtil.shrink5_C("CCCCCCCCC")).to eq "DCD"
    expect(RomanNumeralUtil.shrink5_C("CCCCCCCCCC")).to eq "DD"
  end

  it "Shrink rule (V)" do
    expect(RomanNumeralUtil.shrink2_V("V")).to eq "V"
    expect(RomanNumeralUtil.shrink2_V("VV")).to eq "X"
    expect(RomanNumeralUtil.shrink2_V("VVV")).to eq "XV"
    expect(RomanNumeralUtil.shrink2_V("VVVV")).to eq "XX"
    expect(RomanNumeralUtil.shrink2_V("VVVVV")).to eq "XXV"
    expect(RomanNumeralUtil.shrink2_V("VVVVVV")).to eq "XXX"
    expect(RomanNumeralUtil.shrink2_V("VVVVVVV")).to eq "XXXV"
    expect(RomanNumeralUtil.shrink2_V("VVVVVVVV")).to eq "XXXX"
    expect(RomanNumeralUtil.shrink2_V("VVVVVVVVV")).to eq "XXXXV"
    expect(RomanNumeralUtil.shrink2_V("VVVVVVVVVV")).to eq "XXXXX"
  end

  it "Shrink rule (L)" do
    expect(RomanNumeralUtil.shrink2_L("L")).to eq "L"
    expect(RomanNumeralUtil.shrink2_L("LL")).to eq "C"
    expect(RomanNumeralUtil.shrink2_L("LLL")).to eq "CL"
    expect(RomanNumeralUtil.shrink2_L("LLLL")).to eq "CC"
    expect(RomanNumeralUtil.shrink2_L("LLLLL")).to eq "CCL"
    expect(RomanNumeralUtil.shrink2_L("LLLLLL")).to eq "CCC"
    expect(RomanNumeralUtil.shrink2_L("LLLLLLL")).to eq "CCCL"
    expect(RomanNumeralUtil.shrink2_L("LLLLLLLL")).to eq "CCCC"
    expect(RomanNumeralUtil.shrink2_L("LLLLLLLLL")).to eq "CCCCL"
    expect(RomanNumeralUtil.shrink2_L("LLLLLLLLLL")).to eq "CCCCC"
  end

  it "Shrink rule (D)" do
    expect(RomanNumeralUtil.shrink2_D("D")).to eq "D"
    expect(RomanNumeralUtil.shrink2_D("DD")).to eq "M"
    expect(RomanNumeralUtil.shrink2_D("DDD")).to eq "MD"
    expect(RomanNumeralUtil.shrink2_D("DDDD")).to eq "MM"
    expect(RomanNumeralUtil.shrink2_D("DDDDD")).to eq "MMD"
    expect(RomanNumeralUtil.shrink2_D("DDDDDD")).to eq "MMM"
    expect(RomanNumeralUtil.shrink2_D("DDDDDDD")).to eq "MMMD"
    expect(RomanNumeralUtil.shrink2_D("DDDDDDDD")).to eq "MMMM"
    expect(RomanNumeralUtil.shrink2_D("DDDDDDDDD")).to eq "MMMMD"
    expect(RomanNumeralUtil.shrink2_D("DDDDDDDDDD")).to eq "MMMMM"
  end

  it "Shrink rule (combination)" do
    expect(RomanNumeralUtil.shrink_all("I" * 10)).to eq "X"
    expect(RomanNumeralUtil.shrink_all("I" * 15)).to eq "XV"
    expect(RomanNumeralUtil.shrink_all("I" * 20)).to eq "XX"
    expect(RomanNumeralUtil.shrink_all("I" * 25)).to eq "XXV"
    expect(RomanNumeralUtil.shrink_all("I" * 30)).to eq "XXX"
    expect(RomanNumeralUtil.shrink_all("I" * 35)).to eq "XXXV"
    expect(RomanNumeralUtil.shrink_all("I" * 40)).to eq "XL"
    expect(RomanNumeralUtil.shrink_all("I" * 45)).to eq "XLV"
    expect(RomanNumeralUtil.shrink_all("I" * 50)).to eq "L"
    expect(RomanNumeralUtil.shrink_all("I" * 100)).to eq "C"
    expect(RomanNumeralUtil.shrink_all("I" * 500)).to eq "D"
    expect(RomanNumeralUtil.shrink_all("I" * 1000)).to eq "M"

    expect(RomanNumeralUtil.shrink_all("I" * 11)).to eq "XI"
    expect(RomanNumeralUtil.shrink_all("I" * 16)).to eq "XVI"
    expect(RomanNumeralUtil.shrink_all("I" * 21)).to eq "XXI"
    expect(RomanNumeralUtil.shrink_all("I" * 26)).to eq "XXVI"
    expect(RomanNumeralUtil.shrink_all("I" * 31)).to eq "XXXI"
    expect(RomanNumeralUtil.shrink_all("I" * 36)).to eq "XXXVI"
    expect(RomanNumeralUtil.shrink_all("I" * 41)).to eq "XLI"
    expect(RomanNumeralUtil.shrink_all("I" * 46)).to eq "XLVI"
    expect(RomanNumeralUtil.shrink_all("I" * 51)).to eq "LI"
    expect(RomanNumeralUtil.shrink_all("I" * 101)).to eq "CI"
    expect(RomanNumeralUtil.shrink_all("I" * 501)).to eq "DI"

    expect(RomanNumeralUtil.shrink_all("I" * 14)).to eq "XIV"
    expect(RomanNumeralUtil.shrink_all("I" * 24)).to eq "XXIV"
    expect(RomanNumeralUtil.shrink_all("I" * 34)).to eq "XXXIV"
    expect(RomanNumeralUtil.shrink_all("I" * 44)).to eq "XLIV"
    expect(RomanNumeralUtil.shrink_all("I" * 54)).to eq "LIV"
    expect(RomanNumeralUtil.shrink_all("I" * 104)).to eq "CIV"
    expect(RomanNumeralUtil.shrink_all("I" * 504)).to eq "DIV"
  end
end
